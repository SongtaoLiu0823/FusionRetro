...
This repository contains an implementation of ["FusionRetro: Molecule Representation Fusion via In-Context Learning for Retrosynthetic Planning"](https://arxiv.org/pdf/2209.15315.pdf).  
...
#Train (global_step = 0, trange(1, int(args.epochs)+1, desc="Epoch"))
python train.py --batch_size 64 --epochs 3000  
# After 3000 epochs, I set global_step to 1000000 and continue to train the model with 1000 epochs.  
...
@inproceedings{liu2023fusionretro,
  ...
  author={Liu, Songtao and Tu, Zhengkai and Xu, Minkai and Lin, Lu and Ying, Rex and Tang, Jian and Zhao, Peilin and Wu, Dinghao},

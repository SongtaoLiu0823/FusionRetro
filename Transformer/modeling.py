...
class DecoderLayer(nn.Module):
    ...
    def forward(self, hidden_states, encoder_output, reactants_mask, mutual_mask):
        # self attention
        attention_output = self.self_attention((hidden_states, hidden_states, hidden_states), reactants_mask)
...
class Transformer(nn.Module):
    ...
    def forward(self, products_ids, reactants_ids, products_mask, reactants_mask, mutual_mask):
